...
class FixturesControllerTest < ActionController::TestCase
  ...
  test "should create fixture" do
    assert_difference('Fixture.count') do
      post :create, fixture: { away_team: @fixture.away_team, date: @fixture.date, home_team: @fixture.home_team, league_id: @fixture.league_id, location: @fixture.location }
    end
  ...
  test "should update fixture" do
    put :update, id: @fixture, fixture: { away_team: @fixture.away_team, date: @fixture.date, home_team: @fixture.home_team, league_id: @fixture.league_id, location: @fixture.location }
    assert_redirected_to fixture_path(assigns(:fixture))
  end
